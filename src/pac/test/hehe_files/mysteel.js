...
function InitiateSideMenu() {
	...
	$(document).on("click",".sidebar-menu",
	function(t) {
...
function InitiateWidgets() {
	$(document).on("click",'.widget-buttons *[data-toggle="maximize"]',
	function(n) {
		n.preventDefault();
	...
	$(document).on("click",'.widget-buttons *[data-toggle="collapse"]',
	function(n) {
		n.preventDefault();
		var t = $(this).parents(".widget").eq(0),
...
$(document).on("click","#fullscreen-toggler",
function() {
...
InitiateWidgets();
/*
//# sourceMappingURL=mysteel.min.js.map
*/
