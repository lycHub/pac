var STATUS_ENUM = ['待审核', '审核不通过', '审核通过'];
...
$(function () {
  var formDoms = {
    userName: $('.answerChangeInfoCheckList .userName'),
    phoneNumber: $('.answerChangeInfoCheckList .phoneNumber'),
    company: $('.answerChangeInfoCheckList .company'),
    job: $('.answerChangeInfoCheckList .job'),
    status: $('.answerChangeInfoCheckList .status')
  }

  var btns = {
    resetBtn: $('.answerChangeInfoCheckList .btn-reset'),
    searchBtn: $('.answerChangeInfoCheckList .btn-search')
  }
  ...
  function loadPagination(total) {
    faqPaginations = new FaqPagination({
      el: '.answerChangeInfoCheckList .paginations',
      total: total,
  ...
  function getList() {
    ...
    userServe.getChangeInfoCheckList(params, function (res) {
      if (!res) return;
      tableDatas = res;
      if (oTable) {
    ...
    return new FaqDataTables({
      ...
      columns: [{
        ...
        render: function (data, type, row) {
          var detailLink = '../answerChangeInfo/answerChangeInfo.html?id=' + row.id;
        ...
        render: function(data) {
          ...
          if (STATUS_ENUM[data.status] === '待审核') {
            text = '审核';
            url = '../answerChangeInfoCheck/answerChangeInfoCheck.html?id=';
          }else {
            text = '查看';
            url = '../answerChangeInfo/answerChangeInfo.html?id=';
          }
